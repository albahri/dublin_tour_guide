...
class GuidesControllerTest < ActionController::TestCase
  ...
  test "should create guide" do
    assert_difference('Guide.count') do
      post :create, guide: { date: @guide.date, language: @guide.language, place: @guide.place, time: @guide.time }
    end
  ...
  test "should update guide" do
    patch :update, id: @guide, guide: { date: @guide.date, language: @guide.language, place: @guide.place, time: @guide.time }
    assert_redirected_to guide_path(assigns(:guide))
  end
